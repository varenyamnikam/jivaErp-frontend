...
export default function DcForm(props) {
  ...
  // if (input.partyName) {
  //   accounts.map((item) => {
  //     if (input.partyName == item.acName && input.partyCode !== item.acCode) {
  //       console.log(item, "**");
  //       setInput({
  //         ...input,
  //         partyCode: item.acCode,
  //       });
  //     }
  //   });
  // }
  // if (!input.partyName && input.partyCode) {
  //   accounts.map((item) => {
  //     if (input.partyCode == item.acCode) {
  //       setInput({ ...input, partyName: item.acName });
  //     }
  //   });
  // }
  let x = 0;
